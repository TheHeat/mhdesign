...
date: 2017
image: { 
	path: "./posters/run-refuel-poster.png" 
	}
...
These characters took part in the Cardiff Half for 2 years in a row to highlight the organisation's key messaging around plastic and food waste recyling.
